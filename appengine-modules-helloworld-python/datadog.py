    ...
    def get(self):
        ...
        def get_request_stats(after=None):
            ...
            for req_log in logs:
                ...
                stats['end_time'].append(req_log.end_time)
                stats['resource'].append(req_log.resource)
                stats['status'].append(req_log.status)
        ...
        # modules stats
        stats['modules'] = modules.get_modules()
        stats['module_version'] = modules.get_versions(module='mobile-frontend')
        stats['hostname'] = modules.get_hostname(module='mobile-frontend')
        stats['num_instances'] = modules.get_num_instances()
        # images
        # stats['image_metadata'] = images.get_original_metadata()
        # namespaces
        stats['namespace'] = namespace_manager.get_namespace()
